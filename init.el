...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auctex irony spacemacs-theme cnfonts zenburn-theme helm ivy counsel swiper org-bullets smartparens rainbow-delimiters yasnippet auto-complete auto-complete-clang ac-helm ggtags counsel-gtags clang-format flycheck magit elpy py-autopep8 ein)))
